    ...
    <div class="layout justify-content-between w-100 h-100">
        ...
        <div class="d-flex flex-wrap align-items-start w-75 h-100">
            ...
            <div
                ...
                <div
                    class="item d-flex flex-column w-90 p-5 m-2 gap-2 bg-content border border-dark rounded-3">
                    <div class="d-flex flex-wrap w-100 gap-3" method="POST" action="">
                        <input type="text" name="" id=""
                            ...
                            value="E-Mail:Nome: <?php echo $Usuario['nome'] . ' ' . $Usuario['sobrenome']; ?>" disabled>
                        <button
                            class="btnAtualizar btn bg-DarkGray text-secondary fw-bold glow-hover" disabled>Atualizar</button>
                        <input type="text" name="" id=""
                ...
                <div 
                    class="item d-flex flex-column w-90 p-5 gap-3 m-2 bg-content border border-dark rounded-3">
                    <input type="text" name="" id=""
                        class="form-control border border-secondary bg-transparent text-secondary fw-bold w-40"
                    ...
                    <span class="d-flex gap-2 mt-2">
                        <button class="btnAtualizar btn bg-DarkGray text-secondary fw-bold glow-hover" disabled>+</button>
                        <button class="btnAtualizar btn bg-DarkGray text-secondary fw-bold w-25  glow-hover" disabled>Editar</button>
                    </span>
                </div>
